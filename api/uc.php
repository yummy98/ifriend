...
if(!defined('IN_UC')) {
	...
	//UC CONFIG
	require_once DISCUZ_ROOT.'./source/conf/ucenter.inc.php';
	//OELOVE DB CONNECT
	require_once DISCUZ_ROOT.'./source/conf/db.inc.php';
	...
	if(in_array($get['action'], array('test', 'deleteuser', 'renameuser', 'gettag', 'synlogin', 'synlogout', 'updatepw', 'updatebadwords', 'updatehosts', 'updateapps', 'updateclient', 'updatecredit', 'getcreditsettings', 'updatecreditsettings'))) {
		require_once DISCUZ_ROOT.'./api/ucdb.class.php';
		
		$GLOBALS['db'] = new dbstuff;
		$GLOBALS['db']->connect(DB_HOST, DB_USER, DB_PASS, DB_DATA, DB_PCONNECT, true, DB_CHARSET);
...
class uc_note {
	...
	function uc_note() {
		...
		$this->dbconfig = $this->appdir.'./source/conf/ucenter.inc.php';
		$this->db = $GLOBALS['db'];
	...
	/* 将UC同步给Love */
	function synreg($email, $username, $ucid){
	...
	function updateapps($get, $post) {
		...
		//note 写配置文件
		if(is_writeable($this->appdir.'./api/uc_config.inc.php')) {
