...
<!--{if $a eq "run"}-->
<div class="main-wrap">
  <div class="path"><p>当前位置：用户管理<span>&gt;&gt;</span>会员管理<span>&gt;&gt;</span><a href="<!--{$cpfile}-->?c=money">现金记录</a></p></div>
  <div class="main-cont">
...
<div class="main-wrap">
  ...
  <!--{if $fromtype != 'jdbox'}-->
  <div class="path"><p>当前位置：用户管理<span>&gt;&gt;</span>会员管理<span>&gt;&gt;</span><a href="<!--{$cpfile}-->?c=money&a=add">添加现金记录</a></p></div>
  <!--{/if}-->
