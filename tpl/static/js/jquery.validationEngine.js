...
$.validationEngine = {
	...
	validateCall : function(caller,rules) {	// EXECUTE VALIDATION REQUIRED BY THE USER FOR THIS FIELD
		...
		if(!$(caller).attr("id")) $.validationEngine.debug("这个地方没有ID这个属性( name & class displayed): "+$(caller).attr("name")+" "+$(caller).attr("class"))
						...
						existInarray = false;
			 			 ...
			 			 if(ajaxisError == "false"){			// DATA FALSE UPDATE PROMPT WITH ERROR;
							...
							$.validationEngine.updatePromptText(ajaxCaller,promptText,"",true);				
						 	...
						 	if(!customAjaxRule)	{$.validationEngine.debug("customAjaxRule没有返回值, 请检查.")}		   
