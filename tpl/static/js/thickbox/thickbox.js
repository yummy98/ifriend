...
var tb_pathToImage = _ROOT_PATH + "tpl/static/js/thickbox/loadingAnimation.gif";
	...
	try {
		if (typeof document.body.style.maxHeight === "undefined") {//if IE 6
			...
			if (document.getElementById("TB_HideSelect") === null) {//iframe to hide select elements in ie6
				$("body").append("<iframe id='TB_HideSelect'></iframe><div id='TB_overlay'></div><div id='TB_window'></div><span='TB_tips' style='display:none;'></span>");
		...
		if(urlType == '.jpg' || urlType == '.jpeg' || urlType == '.png' || urlType == '.gif' || urlType == '.bmp'){//code to show images
			...
			if(url.indexOf('TB_iframe') != -1){// either iframe or ajax window
					...
					if(params['modal'] != "true"){//iframe no modal
						...
						/* 改为以下调用 2011.10.26 start*/
						$("#TB_window").append("<div id='TB_title'><div id='TB_ajaxWindowTitle'>"+caption+"</div><div id='TB_closeAjaxWindow'><a href='#' id='TB_closeWindowButton' title='Close'>关闭</a></div></div><iframe frameborder='0' hspace='0' id='TB_iframeContent' name='TB_iframeContent"+Math.round(Math.random()*1000)+"' style='width:"+(ajaxContentW + 29)+"px;height:"+(ajaxContentH + 17)+"px;' > </iframe>");
						tb_showIframe();
						$("#TB_iframeContent").attr('src',urlNoQuery[0]);
						/* end */
						...
						/* 改为以下调用 2011.10.26 start*/
						$("#TB_window").append("<iframe frameborder='0' hspace='0' id='TB_iframeContent' name='TB_iframeContent"+Math.round(Math.random()*1000)+"' style='width:"+(ajaxContentW + 29)+"px;height:"+(ajaxContentH + 17)+"px;'> </iframe>");
						tb_showIframe();
						$("#TB_iframeContent").attr('src',urlNoQuery[0]);
						/* end */
