...
window.webcam = {
	...
	swf_url: 'tpl/static/swf/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	shutter_url: 'tpl/static/swf/shutter.mp3', // URI to shutter.mp3 sound
	...
	set_shutter_sound: function(enabled, url) {
		...
		this.shutter_url = url ? url : 'tpl/static/swf/shutter.mp3';
	},
