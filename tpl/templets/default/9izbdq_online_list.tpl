  ...
  <div class="search_max w960 online_page">
    ...
    <div class="search_sort">
      ...
      <div class="search_sort_sle" id="rank"> 
	    <strong>显示方式：</strong> 
		<a class="btnc btn_c3" href="<!--{$appfile}-->?c=online&a=list<!--{if $page>1}-->&page=<!--{$page}--><!--{/if}--><!--{if !empty($urlitem)}-->&<!--{$urlitem}--><!--{/if}-->"> <span class='h'><b>头像模式</b></span> </a>&nbsp;
		<a class="btnc3 btn_c3" href="<!--{$appfile}-->?c=online&a=list<!--{if $page>1}-->&page=<!--{$page}--><!--{/if}-->&type=more<!--{if !empty($urlitem)}-->&<!--{$urlitem}--><!--{/if}-->"> <span><b>独白模式</b></span> </a> 
	  </div>
    </div>
        ...
        <li>
          ...
          <div class="search_user_inform">
            ...
            <p class="search_vt"> 
			  ...
			  <!--{else}-->
			  <a class="btn_bt1 chat sayHiBtn" href="###" onclick="artbox_hi(<!--{$volist.userid}-->);"><span>打招呼</span></a> 
			  <a class="btn_bt2 mail sendEmailBtn" href="###" onclick="artbox_writemsg(<!--{$volist.userid}-->);">写信件</span></a>
			  <!--{/if}-->
			</p>
          </div>
        </li>
    ...
    <div class="onright"> 
      ...
      <div class="onhead">
	    <!--{assign var='likeuser' value=vo_list("mod={spuser} type={elite} num={9}")}-->
