  ...
  <div class="ce member"> 
    ...
    <div class="search_sort">
      ...
      <div id="rank" class="search_sort_sle"> <strong>显示方式：</strong> 
		...
		<a class="btnc btn_c3" href="<!--{$appfile}-->?c=user&a=list<!--{if $page>1}-->&page=<!--{$page}--><!--{/if}--><!--{if !empty($urlitem)}-->&<!--{$urlitem}--><!--{/if}-->"> <span><b>头像模式</b></span> </a>&nbsp;
		<a class="btnc3 btn_c3" href="<!--{$appfile}-->?c=user&a=list<!--{if $page>1}-->&page=<!--{$page}--><!--{/if}-->&type=more<!--{if !empty($urlitem)}-->&<!--{$urlitem}--><!--{/if}-->"> <span class='h'><b>独白模式</b></span> </a> 
